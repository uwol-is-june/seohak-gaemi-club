...
> 그러나 **실제 산출물**(`reports/AMZN/AMZN-earnings-2026Q2-review.md`)을 열어보니
> `SEC XBRL 시계열 ✅ data.sec.gov 직접 조회 — 등급 A` 로 **XBRL을 직접 쓰고 있었다.**
> 도구가 문서에 명시되지 않아 매 실행 재량에 맡겨질 뿐, 구조적 정확도 열위가 아니었다.
