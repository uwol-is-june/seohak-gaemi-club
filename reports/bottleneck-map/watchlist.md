...
下次复查（**第七十四轮更新**）：🔴 **明日（June 2）CHG H1 FY2026财报（RNS公告）** ——净利润+36%预期验证，EU ASAP €66.7M资助已确认，发布后立即执行/investment-team；🆕⚡ **三星18天罢工执行中（新变量）**：WF6/NF3需求减少，WF6中断时间点推迟至7月，持续监控实际执行进度；🆕 **AXT出口许可证**（最高优先级）：批准后立即重估InP缓解时间线，但P/S 84x仍不可追；🆕 **June 29 Almonty Russell 1000 + 3000指数纳入生效**；**⚡⚡WF6中断新闻**（临界窗口推迟至7月，三星罢工后恢复生产时压力更大）；**⚡⚡June 9（9天）** Almonty Phase 2扩产股东投票+AGM（**日期最终确认：Phase 2投票在June 9 AGM，无独立June 8会议**）（通过则等回调C$20-22再执行/investment-team）；**⚡⚡June 9（9天）** Almonty Phase 2扩产投票+AGM + Sangdong Q2首批生产数据（一并进行）；**⚠️⚠️June 12（12天）** UAMY Annual Meeting——**授权增发250M→500M股表决（稀释风险橙灯）**；**🔴Nittobo深度回调机会**（安全边际入场¥7,700-10,500拆前 / ¥1,540-2,100拆后；5:1拆分记录日June 29）；**⚠️June 15（15天）三叉催化剂日** Centrus DOE续约警戒点（异常沉默，须密集监控）+ China MRL生效 + CHG Nobel挪威公众咨询截止；**Centrus DOE续约（June 30，30天）**；✅ **Soitec FY2026财报已完成评估（5/30）**——★★维持，€90-120入场区间；**⚡Kanto Denka FY2027原始日文TSE公告核实**（英文三源已确认¥95B/¥10B）；**📌Point Break合同授予（DIU近期）**；**⚠️2026-11-27** 中国锑/镓/锗暂停令到期
---
